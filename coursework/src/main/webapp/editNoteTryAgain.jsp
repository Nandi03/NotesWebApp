...
<div class="editNote">
    ...
    %>
    <p>Note name already exists or invalid name for a note! Try again. </p>
    <form action="noteEdit.jsp" id="itemform" method="get">
        <label for="name">Note Name:</label>
        <textarea cols="10" rows="1" id="name" name="newName"><%=name%></textarea><br><br>
        <label for="img">Image URL:</label>
        <textarea cols="10" rows="1" id="img" name="img"><%=img%></textarea><br><br>
        <label for="url">Associated URL:</label>
        <textarea cols="10" rows="1" id="url" name="url"><%=url%></textarea><br><br>
